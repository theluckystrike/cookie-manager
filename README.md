...
- **View All Cookies** — See every cookie for the current site in a clean list
- **Edit Cookies** — Modify name, value, expiration with a simple form
- **Export as JSON** — One-click copy all cookies, formatted and ready
- **JWT Decode** — Automatically detect and decode JWT tokens
- **Cookie Protection** — Read-only mode prevents accidental changes
- **Quick Clear** — Clear cookies by domain with one click
...
Built with 🍪 by [Michael Ip](https://michaelip.dev) | Part of [Zovo](https://zovo.one)
